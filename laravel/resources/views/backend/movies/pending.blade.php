            ...
            <nav aria-label="Page navigation movies">
                <ul class="pagination justify-content-end">
                    <li class="page-item {{ $previous_movie !== null ? '' : 'disabled' }} ">
                        <a class="page-link"
                            href="{{ $previous_movie !== null ? url('admin/' . $type . '/pending/' . $previous_movie) : '#' }}"
                            aria-label="Previous">
                    ...
                    <li class="page-item {{ $next_movie !== null ? '' : 'disabled' }} ">
                        <a class="page-link"
                            href="{{ $next_movie !== null ? url('admin/' . $type . '/pending/' . $next_movie) : '#' }}"
                            aria-label="Next">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.' . $type . '.pending') }}"
                                    id="movieUpdateForm">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-6 offset-md-4">
                                            <a class="btn btn-xs btn-danger" data-button-type="delete"
                                                href="{{ url($type . '/delete/' . $current_movie->id) }}"><i
                            ...
                            <div class="card-footer text-muted">
                                <form method="POST" action="{{ route('admin.' . $type . '.pending') }}"
                                    id="searchAnotherMovie">
                                    @csrf
                                    <div class="form-row">
                                        <div class="col-8">
                                            <input type="text" class="form-control" id="new_title" name="new_movie"
                                                value="{{ $current_movie->title }}">
                                        </div>
                                        <div class="col-2">
