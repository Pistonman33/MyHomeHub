...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('info_series', function (Blueprint $table) {
            ...
            $table->string('yearStart', 12)->nullable();
            $table->string('yearEnd', 12)->nullable();
            $table->unsignedInteger('seasonCount')->nullable();
            $table->unsignedInteger('episodeCount')->nullable();
            $table->unsignedInteger('lastSeasonNumber')->nullable();
